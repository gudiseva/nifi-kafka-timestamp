...
@SeeAlso({ConsumeKafkaTimestamp_0_10.class})
public class ConsumeKafkaRecordTimestamp_0_10 extends AbstractProcessor {
    ...
    protected ConsumerPool createConsumerPool(final ProcessContext context, final ComponentLog log) {
        ...
        final String topicListing = context.getProperty(ConsumeKafkaRecordTimestamp_0_10.TOPICS).evaluateAttributeExpressions().getValue();
        final String topicType = context.getProperty(ConsumeKafkaRecordTimestamp_0_10.TOPIC_TYPE).evaluateAttributeExpressions().getValue();
